      ...
      <div className="py-10">
        {events!.map((event) => (
          <div
            ...
            className="group/event flex border-b last:border-0 hover:border-yellow-300 gap-4 sm:gap-8 flex-col sm:flex-row py-4 sm:py-0 transition-colors duration-300"
            key={event._id}
          >
